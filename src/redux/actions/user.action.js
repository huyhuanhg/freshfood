...
export const checkEmailExistsAction = createAction(
  REQUEST(USER_ACTION.CHECK_EMAIL_EXISTS)
);
export const refreshTokenUserAction = createAction(
  REQUEST(USER_ACTION.REFRESH_TOKEN)
);
