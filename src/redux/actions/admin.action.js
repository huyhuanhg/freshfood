...
export const checkAdminEmailExistsAction = createAction(REQUEST(ADMIN_ACTION.CHECK_ADMIN_EMAIL_EXISTS));
export const refreshAdminTokenUserAction = createAction(REQUEST(ADMIN_ACTION.REFRESH_ADMIN_TOKEN));