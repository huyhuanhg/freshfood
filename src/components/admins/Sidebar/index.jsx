...
import {
    ...
    DashboardOutlined,
    FolderViewOutlined, MoneyCollectOutlined, OrderedListOutlined, ShopOutlined,
    UploadOutlined,
    UserOutlined
...
function Sidebar({collapsed}) {
    ...
    return (
        <StyteSidebar.Wrap width={300} collapsedWidth={0} theme="light" trigger={null} collapsible
                           collapsed={collapsed}>
            <StyteSidebar.Logo>
